...
import {AdvancedDiagnosticError, createCodeFrame, type AdvancedDiagnostic, type AdvancedFailureReport} from './diagnostics.js';
...
function runtimePackagePaths(): Record<string, string[]> {
...
function createVirtualCompilerHost(options: ts.CompilerOptions): ts.CompilerHost {
...
function diagnosticFile(projectFile: string, diagnostic: ts.Diagnostic): Pick<AdvancedDiagnostic, 'file' | 'relativeFile' | 'line' | 'column' | 'codeFrame'> {
...
function toAdvancedDiagnostic(projectFile: string, diagnostic: ts.Diagnostic): AdvancedDiagnostic {
...
export function validateAdvancedProjectTypes(projectFileInput: string): AdvancedTypecheckResult {
...
export class AdvancedTypecheckError extends AdvancedDiagnosticError {
  public readonly validation: AdvancedTypecheckResult;
