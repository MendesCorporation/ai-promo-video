...
export const motionComponentLibrary: MotionComponent[] = [
  ...
  component('organic-morph-wipe', 'Organic Morph Wipe', 'transition', 'An SVG form morphs and expands across the frame to reveal the next composition.', ['organic', 'morph', 'wipe', 'svg', 'mask'], ['playful', 'cinematic', 'premium'], ['energetic', 'impact'], ['morphVectorPath'], ['fromPath', 'toPath', 'origin', 'duration'], 'Derive the silhouette and direction from scene content rather than using a generic blob.'),
  component('shared-element-bridge', 'Shared Element Bridge', 'transition', 'A product control, card, keyword, or image persists and transforms into its role in the next shot.', ['shared-element', 'object', 'continuity', 'match', 'transition'], ['clever', 'premium', 'narrative'], ['measured', 'impact'], ['cameraMove', 'focalCrop'], ['fromBounds', 'toBounds', 'zPath', 'rotation'], 'Use one narratively meaningful object and match its measured bounds on both sides.'),
  component('whip-pan-bridge', 'Whip Pan Bridge', 'transition', 'A fast camera vector with short directional blur carries energy across two authored poses.', ['whip', 'pan', 'camera', 'blur', 'speed'], ['cinematic', 'energetic', 'bold'], ['impact'], ['cameraMove'], ['direction', 'distance', 'blurFrames', 'settle'], 'Keep the blur brief, preserve travel direction, and inspect the first settled destination frame.'),
  component('displacement-reveal', 'Displacement Reveal', 'transition', 'A procedural noise or luma field displaces the boundary between outgoing and incoming layers.', ['displacement', 'noise', 'luma', 'wipe', 'shader'], ['cinematic', 'organic', 'technical'], ['energetic', 'impact'], ['FlowField'], ['map', 'direction', 'softness', 'duration'], 'Author a deterministic map and keep important text away from the unstable edge.'),
  ...
  component('ambient-camera-rig', 'Ambient Camera Rig', 'camera', 'Low-frequency travel, zoom breathing, and roll keep the camera alive beneath larger authored moves.', ['ambient', 'camera', 'continuous', 'dolly', 'drift'], ['cinematic', 'premium', 'alive'], ['quiet', 'measured'], ['ambientCamera', 'runWithAmbientMotion'], ['duration', 'travel', 'zoom', 'roll', 'speed', 'seed'], 'Run concurrently for the full shot. Keep overscan available, avoid fighting intentional focus moves, and use a unique seed and amplitude for the composition.'),
  component('ambient-parallax-rig', 'Ambient Parallax Rig', 'camera', 'Foreground, subject, and background layers share one continuous motion field at authored depth factors.', ['ambient', 'parallax', 'depth', 'continuous', 'layers'], ['cinematic', 'spatial', 'premium'], ['quiet', 'measured'], ['ambientParallax', 'runWithAmbientMotion'], ['refs', 'depths', 'travel', 'scaleAmplitude', 'speed', 'seed'], 'Assign depths by hierarchy, not array convenience. Protect frame edges with overscan and keep the focal subject most stable.'),
