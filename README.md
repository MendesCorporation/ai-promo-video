...
```bash
npx --yes --package github:MendesCorporation/ai-promo-video ai-promo-video install
```
...
```bash
npx --yes --package github:MendesCorporation/ai-promo-video ai-promo-video install --clients codex,cursor
npx --yes --package github:MendesCorporation/ai-promo-video ai-promo-video install --clients claude
npx --yes --package github:MendesCorporation/ai-promo-video ai-promo-video install --clients claude-code
npx --yes --package github:MendesCorporation/ai-promo-video ai-promo-video install --clients claude-desktop
npx --yes --package github:MendesCorporation/ai-promo-video ai-promo-video install --dry-run
```
...
```powershell
npx.cmd --yes --prefer-online --package github:MendesCorporation/ai-promo-video ai-promo-video install
```
